...
<!-- PROČITANE PORUKE -->
		<table class="table table-hover">
	 	<tr><h4><b>Arhivirane poruke:</b></h4></tr>
  <tr tr style="color: grey;">
...
$naslovPoruke = mysqli_query($link,"SELECT * FROM poruke WHERE primalac = '$imeUlogovaneFirme' && otvoreno = 'yes' && brisanjePrimaoca = '0' && vaznePoruke !='1'");
...
if (isset($_GET['izbrisi'])) {
		...
		echo "<script>window.open('poruke-arhiva.php','_self') </script>";
			}
